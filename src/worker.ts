...
const worker = new Worker(
  ...
  async (job: Job<IssueJobData>) => {
    ...
    try {
      ...
      console.log('🔍 Found relevant code chunks:', chunks.length);
      ...
      if (chunks.length > 0) {
        ...
        console.log('⚠️  No relevant chunks found, skipping fix generation');
      }
      ...
      throw err; // Let BullMQ handle the error
    }
  },
  { connection }
);
